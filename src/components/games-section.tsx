...
export function GamesSection() {
  ...
  return (
    <div className="w-full min-h-[calc(100vh-4rem)] flex flex-col justify-center bg-gradient-to-br from-background to-muted/30 py-12">
              ...
              <CardContent className="space-y-3 pt-0">
                ...
                <div className="flex gap-2">
                  <Button size="sm" asChild>
                    ...
                    >
                      <PlayIcon />
                      <span className="ml-2">Jogar</span>
                    </a>
                  </Button>
